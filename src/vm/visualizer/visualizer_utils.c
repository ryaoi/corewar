...
/*   Updated: 2019/05/21 19:00:47 by jaelee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_visualizer(t_visualizer_state *vis_state)
{
	...
	vis_state->win.info = newwin(4 + (MEM_SIZE / 64), INFO_WIDTH, 0, MEM_DUMP_WIDTH - 1);
	...
	pthread_create(&vis_state->input_worker, NULL, input_loop_wrapper, vis_state);
